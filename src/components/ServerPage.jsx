    ...
    useEffect(() => {
        ...
        loadedServer.getGeneralInfo()
            .then((serverInfo) => {
                ...
                setServerPort(serverInfo?.server_port ?? null);
                            ...
                            <TabsContents>
                                <TabsContent value="overview">
                                    ...
                                    {isRunning && serverPort && (
                                        <a
                                            href={`${loadedServer.baseUrl}/${serverPort}`}
                                            target="_blank"
                                        ...
                                        >
                                            🟢 Open server on port {serverPort}
                                        </a>
                                    )}
                                </TabsContent>
...
export default ServerPage;import { useState, useEffect, useRef } from "react";
import manager from "@/utils/manager.js";
import Console from "./Console.jsx";
import QuickCommands from "./QuickCommands.jsx";
import PlayersAvatarPanel from "./PlayersAvatarPanel.jsx";
